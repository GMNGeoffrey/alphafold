...
"""Meta script to generate the command to run alphafold.

This is forked from the run_docker.py script, but it just outputs the command to
use to run alphafold in your own container.
"""
...
def main(argv):
  ...
  for name, path in database_paths:
    ...
    output_target_path=FLAGS.output_dir
  ...
  print("\n\npython run_alphafold.py", " ".join(command_args), "\n")
